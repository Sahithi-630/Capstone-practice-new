...
const interviewQuestions = require('../data/interviewQuestions.json'); // Adjust the path if necessary

// GET endpoint to fetch all interview questions
interviewQuestionsRouter.get('/interviewQuestions', (req, res) => {
    try {
        res.status(200).json(interviewQuestions); // Send JSON data as response
    } catch (error) {
